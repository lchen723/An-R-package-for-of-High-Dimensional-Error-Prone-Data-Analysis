...
set.seed(202270)
 ...
 naive = Boost_VSE(Y,Xstar,type="poisson",Iter=100)$BetaHat

 correctL = SIMEXBoost(Y,Xstar,zeta=c(0,0.25,0.5,0.75,1),B=5, type="poisson",sigmae=Sig,
  Iter=100, Lambda=0, Extrapolation="linear")$BetaHatCorrect
   correctL[which(abs(correctL)<0.5)]=0
 correctQ = SIMEXBoost(Y,Xstar,zeta=c(0,0.25,0.5,0.75,1),B=5, type="poisson",sigmae=Sig,
